...
def test_ai_suggestions_api():
    ...
    state_response = requests.get(f"{BASE_URL}/morning-orientation/user-state", headers=headers)
    ...
    suggestions_response = requests.post(f"{BASE_URL}/morning-orientation/ai-suggestions", headers=headers)
...
def check_prerequisites():
    ...
    # Check wellness data
    wellness_response = requests.get(f"{BASE_URL}/wellness/daily-metrics/latest", headers=headers)
