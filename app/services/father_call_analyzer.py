...
"""
    ...
    def _normalize_analysis_result(self, parsed_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        total_selections = sum(len(selections) if isinstance(selections, list) else 1 for selections in matrix_selections.values())
    ...
    def _validate_father_call_content(self, conversation_text: str) -> bool:
        ...
        logger.info(
            f"Content validation: father={has_father_reference}, call={has_call_reference}, problem={has_problem_reference}, therapy={has_therapy_context}, substantial={has_substantial_content}, final={final_valid}"
        )
